...
export declare const deleteAllBatches: (req: Request, res: Response) => Promise<void>;
...
export declare const createBatchFromCSV: (req: Request, res: Response) => Promise<void>;
